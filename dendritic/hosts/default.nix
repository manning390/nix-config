{config, inputs, lib,  ...}: {
    ...
    config.flake = let
        ...
        mkNixosConfig = machineName: hostCfg: inputs.nixpkgs.lib.nixosSystem  {
            ...
            modules = let
                ...
                aspectModules = map (aspect: config.flake.modules.nixos.${aspect})
         ...
         in {
                ...
                checks.x86_64-linux = lib.mapAttrs (machineName: _: {
